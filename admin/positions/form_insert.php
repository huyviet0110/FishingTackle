		...
		<div class="content">
			...
			<div class="form">
				<div class="form-title">
					<h3 class="h3-format">Add a new positions</h3>
				</div>
				<div class="form-content">
					<form method="post" action="process_insert.php">
						...
						<div class="form-input">
							<p>Salary</p>
							<input type="number" name="salary" id="input_salary" step="any" required>
							<div id="salary_error"></div>
						</div>
						<div class="form-input">
							<p>Level</p>
							<input type="number" name="level" id="input_level" required>
							<div id="level_error"></div>
						</div>
						<input type="hidden" name="page" value="<?php echo $page ?>" required>
