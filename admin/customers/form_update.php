		...
		<div class="content">
			...
			<div class="form">
				<div class="form-title">
					<h3 class="h3-format">Update this customer</h3>
				</div>
				<div class="form-content">
					<form method="post" action="process_update.php" enctype="multipart/form-data">
						...
						<div class="form-old-image">
							<p>Old avatar</p>
							<img src="avatars/<?php echo $each['avatar'] ?>" height="180px" width="180px" style="border: 1px solid white; border-radius: 50%;" required>
						</div>
